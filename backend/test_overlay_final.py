...
def main():
    print("="*60)
    print("Final Test: No-frills overlay")
    print("="*60)
    ...
    bg_path = os.path.join(OUTPUT_DIR, "final_bg_1.png")
    img.save(bg_path, "PNG")
    result = simulate_overlay(bg_path, screenshots["ref1"], right_card, "R1")
    result.save(os.path.join(OUTPUT_DIR, "final_1_right.png"), "PNG")
    print("Saved: final_1_right.png")
    ...
    img = generate_slide_image(prompt, resolution="1K", aspect_ratio="16:9")
    bg_path = os.path.join(OUTPUT_DIR, "final_bg_2.png")
    img.save(bg_path, "PNG")
    temp = simulate_overlay(bg_path, screenshots["ref1"], right_card, "R1")
    result = simulate_overlay(temp, screenshots["ref2"], left_card, "R2")
    result.save(os.path.join(OUTPUT_DIR, "final_2_lr.png"), "PNG")
    print("Saved: final_2_lr.png")
