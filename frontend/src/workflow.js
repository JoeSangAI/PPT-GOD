// Keep this JS mirror for the lightweight Node workflow smoke test.
// The app imports the typed implementation from workflow.ts.
...
function getStepIndex(projectStatus, facts) {
...
function getStepStatus(projectStatus, stepIndex, idx) {
...
export function getPrimaryActionKey(state) {
...
export function getSecondaryActionKeys(state) {
  const actions = [];
  ...
  // Page regeneration actions are intentionally local page/card actions.
  if (state.projectStatus === "completed") {
